...
inventory_tab =     [[
                        sg.Frame(layout = 
                        [
                            [sg.Column([[sg.Image(data = icm_f.generate_img('images/Empty Slot.png', (72, 72), False), enable_events = True, key = 'inventory{}'.format(4 * i + j)) for j in range(0, 4)] for i in range(0, 4)])],

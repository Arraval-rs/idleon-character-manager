...
for i in range(0, 6):
	for j in range(0, 3):
		...
		if 3 * i + j < len(icm_f.monsters['W4']):
			world4_tab[i].append(sg.Image(data = icm_f.generate_img('images/Cards/{} Card.png'.format(icm_f.monsters['W4'][3 * i + j]['Name']), (56, 72), False), key = 'W4_{}'.format(3 * i + j), enable_events = True))
